...
static rasterizer_info SpriteRSState()
{
	rasterizer_info result;
	result.CullMode = D3D11_CULL_NONE;
	result.DepthClipEnable = false;
	return result;
}

static sampler_info SpriteSamplerState()
{
	sampler_info result;
...
static depth_stencil_info SpriteDepthStencilState()
{
	depth_stencil_info result;
